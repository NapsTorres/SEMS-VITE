...
const corsOptions = {
  ...
  allowedHeaders: ['Content-Type', 'Authorization', 'X-Requested-With'], // Allow X-Requested-With
  optionsSuccessStatus: 200,
};

app.use(cors(corsOptions));  // Use CORS middleware with the updated configuration
...
// Setting up routes with your API version
